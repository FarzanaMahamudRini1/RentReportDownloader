...
class Apitester
{
    static async Task Main(string[] args)
    {
        ...
        // Load propids
        string propidFilePath = @"C:\Users\Intern1\Desktop\PnLsPipeline\propids.txt";
        ...
        using (HttpClient client = new HttpClient())
        {
            ...
            foreach (string propid in propids)
            {
                ...
                string url = $"/Reports/43/RunReport?parameters=StartDate,{startDate};EndDate,{endDate};PropOwnerIDs,{trimmedPropid}&GetOptions=ReturnCSVStream";
                ...
                string reportPath = $@"C:\Users\Intern1\Desktop\reports csv\{trimmedPropid}";
